...
public class MvcConfigTest {
	...
	private User userWithNOUSERRole;

	@Before
	public void setup() {
		userWithUSERRole = new User();
		userWithUSERRole.setUsername("werka");
		userWithUSERRole.setPassword("werka");

		userWithNOUSERRole = new User();
		userWithNOUSERRole.setUsername("admin");
		userWithNOUSERRole.setPassword("root");
	}
	...
	public void loginUser() throws Exception {
		this.mockMvc.perform(formLogin()
				.user(userWithUSERRole.getUsername())
	...
	public void loginUserAccessProtected() throws Exception {
		MvcResult mvcResult = this.mockMvc.perform(formLogin()
				.user(userWithUSERRole.getUsername())
				.password(userWithUSERRole.getPassword()))
				.andExpect(authenticated())
				.andReturn();
	...
	public void loginUserAccessProtectedInvalid() throws Exception {
		MvcResult mvcResult = this.mockMvc.perform(formLogin()
				.user(userWithNOUSERRole.getUsername())
				.password(userWithNOUSERRole.getPassword()))
				.andExpect(authenticated())
				.andReturn();
